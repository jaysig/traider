...
class TradesControllerTest < ActionController::TestCase
  ...
  test "should create trade" do
    assert_difference('Trade.count') do
      post :create, trade: { description: @trade.description, email: @trade.email, location: @trade.location, price: @trade.price, user_id: @trade.user_id }
    end
  ...
  test "should update trade" do
    patch :update, id: @trade, trade: { description: @trade.description, email: @trade.email, location: @trade.location, price: @trade.price, user_id: @trade.user_id }
    assert_redirected_to trade_path(assigns(:trade))
  end
